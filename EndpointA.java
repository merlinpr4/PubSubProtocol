...
public class EndpointA extends Node {
	static final int DEFAULT_SRC_PORT = 49600; //come back to this 
	 ...
	 * the destinations
	 */
	EndpointA(Terminal terminal, String dstHost, int dstPort, int srcPort) {
		try {
	...
	public static void main(String[] args) {
		try {
			Terminal terminal = new Terminal("EndnodeA");
			(new EndpointA(terminal, DEFAULT_DST_NODE, DEFAULT_DST_PORT, DEFAULT_SRC_PORT)).start();
